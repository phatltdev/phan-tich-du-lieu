...
\footnotesize Python source: \texttt{src/analyze\_heart\_disease.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Heart Age Hist}).}
\label{fig:ch4_heart_hist}
\end{figure}

\textbf{Nhận xét Hình \ref{fig:ch4_heart_hist}.} Histogram tuổi thô và histogram tuổi sau tiền xử lý gần như trùng nhau, cho thấy biến \texttt{age} không chịu tác động đáng kể từ bước làm sạch. Phân phối tập trung nhiều ở nhóm trung niên và lớn tuổi, khoảng 50--60 tuổi xuất hiện dày hơn các nhóm còn lại; điều này phù hợp với bối cảnh bệnh tim thường được khảo sát nhiều ở nhóm tuổi có nguy cơ cao. Vì hình dạng phân phối không bị biến dạng sau tiền xử lý, \texttt{age} có thể được giữ nguyên để đưa vào mô hình phân loại.
...
\end{subfigure}
\captionsetup{justification=raggedright,singlelinecheck=false}
\caption[Boxplot cholesterol Heart Disease: Python và Excel]{Boxplot cholesterol trên Heart Disease, đối chiếu giữa Python và Excel.\\
\footnotesize Python source: \texttt{src/analyze\_heart\_disease.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Heart Boxplot}).}
\label{fig:ch4_heart_boxplot}
\end{figure}

\textbf{Nhận xét Hình \ref{fig:ch4_heart_boxplot}.} Boxplot cholesterol theo \texttt{target\_binary} cho thấy cả hai nhóm đều có nhiều giá trị nằm ngoài hộp IQR, đặc biệt ở vùng cholesterol cao. Trung vị giữa nhóm có bệnh và không bệnh không tách quá xa, nghĩa là \texttt{chol} một mình chưa đủ phân biệt lớp, nhưng các điểm ngoại lai và độ trải rộng vẫn mang thông tin lâm sàng cần kiểm soát. Vì vậy tiền xử lý nên dùng IQR clipping hoặc kiểm tra ngoại lai có điều kiện, thay vì loại bỏ cơ học toàn bộ các điểm cao.
...
\caption[Scatter plot \texttt{age}--\texttt{thalach}: Python và Excel]{}
...
\end{subfigure}
\captionsetup{justification=raggedright,singlelinecheck=false}
\caption[]{Scatter plot giữa tuổi và nhịp tim tối đa.\\
\footnotesize Python source: \texttt{src/analyze\_heart\_disease.py}.\\
...
\footnotesize Python source: \texttt{src/analyze\_heart\_disease.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Heart Target}).}
...
\begin{subfigure}{0.86\textwidth}
 ...
 \caption{Python -- Heatmap tương quan}
\end{subfigure}
...
\begin{subfigure}{0.86\textwidth}
 \centering
 \includegraphics[width=\textwidth]{images/ch3/excel_heart_corr_heatmap_preview.png}
 \caption{Excel -- Heatmap tương quan}
\end{subfigure}
\captionsetup{justification=raggedright,singlelinecheck=false}
\caption[Heatmap tương quan Heart Disease: Python và Excel]{Heatmap tương quan các biến định lượng Heart Disease, đối chiếu giữa Python và Excel.\\
\footnotesize Python source: \texttt{src/analyze\_heart\_disease.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Heart Corr Heatmap}).}
...
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{CDC HighBP}).}
...
\footnotesize Python source: \texttt{src/analyze\_cdc\_diabetes.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{CDC BMI Hist}).}
...
\begin{subfigure}{0.90\textwidth}
 ...
 \caption{Python -- Boxplot \texttt{BMI} theo target}
\end{subfigure}
\par\medskip
\begin{subfigure}{0.90\textwidth}
 \centering
 \includegraphics[width=\textwidth]{images/ch3/excel_cdc_bmi_boxplot_preview.png}
 \caption{Excel -- Boxplot \texttt{BMI} theo target}
\end{subfigure}
\captionsetup{justification=raggedright,singlelinecheck=false}
\caption[Boxplot \texttt{BMI} CDC Diabetes: Python và Excel]{Boxplot \texttt{BMI} theo \texttt{Diabetes\_binary}, đối chiếu giữa Python và Excel.\\
\footnotesize Python source: \texttt{src/analyze\_cdc\_diabetes.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{CDC BMI Boxplot}).}
...
\footnotesize Python source: \texttt{src/analyze\_cdc\_diabetes.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{CDC Age BMI}).}
...
\footnotesize Python source: \texttt{src/analyze\_cdc\_diabetes.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{CDC Target}).}
...
\begin{subfigure}{0.86\textwidth}
 \centering
 \includegraphics[width=\textwidth]{images/ch3/excel_cdc_corr_heatmap_preview.png}
 \caption{Excel -- Heatmap tương quan}
\end{subfigure}
\captionsetup{justification=raggedright,singlelinecheck=false}
\caption[Heatmap tương quan CDC Diabetes: Python và Excel]{Heatmap tương quan các biến CDC Diabetes, đối chiếu giữa Python và Excel.\\
\footnotesize Python source: \texttt{src/analyze\_cdc\_diabetes.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{CDC Corr}).}
...
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Breast Target}).}
...
\footnotesize Python source: \texttt{src/analyze\_tabular\_health.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Breast Radius Hist}).}
...
\begin{subfigure}{0.90\textwidth}
 ...
 \caption{Python -- Boxplot \texttt{radius1} theo B/M}
\end{subfigure}
\par\medskip
\begin{subfigure}{0.90\textwidth}
 \centering
 \includegraphics[width=\textwidth]{images/ch3/excel_breast_radius_boxplot_preview.png}
 \caption{Excel -- Boxplot \texttt{radius1} theo B/M}
\end{subfigure}
\caption[Boxplot \texttt{radius1} Breast Cancer: Python và Excel]{Boxplot \texttt{radius1} theo chẩn đoán B/M, đối chiếu giữa Python và Excel.\\
\footnotesize Python source: \texttt{src/analyze\_tabular\_health.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Breast Radius Boxplot}).}
...
\footnotesize Python source: \texttt{src/analyze\_tabular\_health.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Breast Scatter}).}
...
\begin{subfigure}{0.86\textwidth}
 \centering
 \includegraphics[width=\textwidth]{images/ch3/excel_breast_corr_heatmap_preview.png}
 \caption{Excel -- Heatmap tương quan}
\end{subfigure}
\caption[Heatmap tương quan Breast Cancer: Python và Excel]{Heatmap tương quan các đặc trưng hình thái Breast Cancer, đối chiếu giữa Python và Excel.\\
\footnotesize Python source: \texttt{src/analyze\_tabular\_health.py}.\\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Breast Corr}).}
...
\footnotesize Python source: \texttt{src/analyze\_appliances\_energy.py}. Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Appliances Daily}).}
...
\begin{figure}[H]\centering
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/appliances_energy_rolling_trend.png}\caption{Python -- Rolling mean/std}\end{subfigure}
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_appliances_rolling_trend_preview.png}\caption{Excel -- Rolling mean/std}\end{subfigure}
\caption[Rolling statistics Appliances Energy: Python và Excel]{Rolling mean và rolling standard deviation 1 ngày của \texttt{Appliances}.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
\begin{figure}[H]\centering
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/appliances_energy_missing_interpolation_ffill.png}\caption{Python -- Interpolation/Forward fill}\end{subfigure}
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_appliances_missing_interpolation_ffill_preview.png}\caption{Excel -- Interpolation/Forward fill}\end{subfigure}
\caption[Điền khuyết thời gian Appliances Energy: Python và Excel]{Minh họa xử lý missing theo thời gian bằng interpolation và forward fill.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Appliances Histogram}).}
...
\begin{figure}[H]\centering
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/appliances_energy_differencing_line.png}\caption{Python -- Differencing}\end{subfigure}
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_appliances_differencing_line_preview.png}\caption{Excel -- Differencing}\end{subfigure}
\caption[Differencing Appliances Energy: Python và Excel]{Sai phân bậc một của \texttt{Appliances}.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_appliances_ridgeline_preview.png}\caption{Excel -- Monthly histogram approximation}\end{subfigure}
\caption[Mùa vụ Appliances Energy: Python và Excel]{Phân phối \texttt{log1p(Appliances)} theo tháng.\
\footnotesize Python source: \texttt{src/analyze\_appliances\_energy.py}.\
Excel source/workbook: \texttt{src/create\_excel\_visualizations.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (\texttt{Appliances Ridgeline}).}
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_har_activity_distribution_preview.png}\caption{Excel -- Activity distribution}\end{subfigure}
\caption[Phân bố hoạt động HAR: Python và Excel]{Tần suất các hoạt động trong HAR.\
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_har_selected_feature_line_preview.png}\caption{Excel -- Feature line sample}\end{subfigure}
\caption[Line chart HAR: Python và Excel]{Line chart theo index mẫu của 5 feature HAR đã chọn.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_har_five_feature_boxplot_preview.png}\caption{Excel -- Boxplot 5 features}\end{subfigure}
\caption[Boxplot HAR: Python và Excel]{Boxplot 5 feature HAR theo hoạt động.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_har_corr_heatmap_preview.png}\caption{Excel -- Correlation heatmap}\end{subfigure}
\caption[Heatmap HAR: Python và Excel]{Heatmap tương quan 5 feature HAR.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_mhealth_activity_distribution_preview.png}\caption{Excel -- Activity distribution}\end{subfigure}
\caption[Phân bố hoạt động MHEALTH: Python và Excel]{Tần suất hoạt động trong mẫu MHEALTH.\
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_mhealth_selected_sensor_line_preview.png}\caption{Excel -- Sensor line sample}\end{subfigure}
\caption[Line chart MHEALTH: Python và Excel]{Line chart theo index mẫu của 6 sensor MHEALTH.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_mhealth_sensor_boxplot_preview.png}\caption{Excel -- Sensor boxplot}\end{subfigure}
\caption[Boxplot MHEALTH: Python và Excel]{Boxplot sensor theo hoạt động MHEALTH.\
\footnotesize Python source: \texttt{src/analyze\_mhealth.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_mhealth_rolling_diff_preview.png}\caption{Excel -- Rolling/differencing}\end{subfigure}
\caption[Rolling và differencing MHEALTH: Python và Excel]{Rolling mean và sai phân của \texttt{sensor\_01}.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
...
\par\medskip
\begin{subfigure}{0.90\textwidth}\centering\includegraphics[width=\textwidth]{images/ch3/excel_mhealth_corr_heatmap_preview.png}\caption{Excel -- Correlation heatmap}\end{subfigure}
\caption[Heatmap MHEALTH: Python và Excel]{Heatmap tương quan các sensor MHEALTH đã chọn.\
\footnotesize Python source: \texttt{scripts/generate\_group\_b\_figures.py}.\
Excel source/workbook: \texttt{scripts/generate\_group\_b\_figures.py}, \texttt{excel/excel\_visualization\_comparison.xlsx} (Excel-style preview).}
